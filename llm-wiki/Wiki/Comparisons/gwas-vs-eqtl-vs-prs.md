...
| Feature | A | B |
|---|---|---|
| Main distinction | GWAS maps trait associations, eQTL maps expression effects, and PRS aggregates risk. | Different representation and objective |

## Detailed Explanation
GWAS maps trait associations, eQTL maps expression effects, and PRS aggregates risk. The distinction matters because MLCB often revisits the same biological problem through increasingly expressive computational representations.
...
## Summary
GWAS maps trait associations, eQTL maps expression effects, and PRS aggregates risk.
