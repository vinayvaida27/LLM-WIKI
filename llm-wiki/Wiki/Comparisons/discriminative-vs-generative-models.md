...
| Feature | A | B |
|---|---|---|
| Main distinction | Discriminative models predict labels; generative models learn to sample or reconstruct data. | Different representation and objective |

## Detailed Explanation
Discriminative models predict labels; generative models learn to sample or reconstruct data. The distinction matters because MLCB often revisits the same biological problem through increasingly expressive computational representations.
...
## Summary
Discriminative models predict labels; generative models learn to sample or reconstruct data.
