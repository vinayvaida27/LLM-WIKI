...
source_count: 18
aliases:
  - "Bulk vs Single-Cell Expression"
---
...
| Feature | A | B |
|---|---|---|
| Main distinction | Bulk averages many cells; single-cell resolves heterogeneity. | Different representation and objective |

## Detailed Explanation
Bulk averages many cells; single-cell resolves heterogeneity. The distinction matters because MLCB often revisits the same biological problem through increasingly expressive computational representations.
...
## Summary
Bulk averages many cells; single-cell resolves heterogeneity.
