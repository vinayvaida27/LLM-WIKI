...
## Figure Availability
Original slide images are not embedded in the current source files. Lecture pages preserve figure-like explanations when the text describes them.

## Manual Review
Add richer visual descriptions if slide images are imported later.
