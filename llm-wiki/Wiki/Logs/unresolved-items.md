...
## Figure Detail
Original slide images are not embedded. Figure explanations are text-based.

## Schema Suggestions
The schema only allows 	opic, concept, entity, project, and log tags. Method, equation, comparison, and figure pages therefore use compatible tags while living in clearer folders.

## Source Comparison
Raw/Sources/ and Raw/Files/ should be compared later if source provenance becomes important.
