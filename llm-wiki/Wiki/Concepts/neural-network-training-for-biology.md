...
## Overview
Neural network training connects data representation, architecture, loss, backpropagation, optimizers, validation, and regularization to biological prediction tasks.
